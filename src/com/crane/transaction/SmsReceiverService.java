...
import com.crane.sms.ui.Recycler;
import com.crane.sms.widget.MmsWidgetProvider;
import com.crane.smsapp.LogTag;
import com.crane.smsapp.MmsConfig;
import com.crane.utils.SendingProgressTokenManager;
import com.crane.utils.ServiceState;
...
public class SmsReceiverService extends Service {
    ...
    public static final String ACTION_SEND_MESSAGE =
            "com.crane.transaction.SEND_MESSAGE";
...
//                return "SmsManager.RESULT_ERROR_FDN_CHECK_FAILURE";
    ...
    private void handleSmsSent(Intent intent, int error) {
        ...
        if (mResultCode == Activity.RESULT_OK) {
            ...
            if (!com.crane.utils.Sms.moveMessageToFolder(this, uri, Sms.MESSAGE_TYPE_SENT, error)) {
            ...
            com.crane.utils.Sms.moveMessageToFolder(this, uri, Sms.MESSAGE_TYPE_QUEUED, error);
    ...
    private void messageFailedToSend(Uri uri, int error) {
        ...
        com.crane.utils.Sms.moveMessageToFolder(this, uri, Sms.MESSAGE_TYPE_FAILED, error);
