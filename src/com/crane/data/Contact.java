...
//    };
    ...
    public static String formatNameAndNumber(String name, String number, String numberE164) {
        ...
        if (!MessageUtils.isEmailAddress(number)) {
            formattedNumber = MessageUtils.formatNumber(number, numberE164,
                    "CN");
        }
    ...
    public synchronized void setNumber(String number) {
        if (!MessageUtils.isEmailAddress(number)) {
            mNumber = MessageUtils.formatNumber(number, mNumberE164,
                    "CN");
        } else {
            mNumber = number;
        }
...
//            }
        ...
        private Contact getContactInfoForPhoneNumber(String number) {
            ...
            String normalizedNumber = MessageUtils.normalizeNumber(number);
            ...
            if (!TextUtils.isEmpty(normalizedNumber) && !TextUtils.isEmpty(minMatch)) {
                ...
                String numberE164 = MessageUtils.formatNumberToE164(
                        number, "CN");
                String selection;
                String[] args;
