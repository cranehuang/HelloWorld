...
import com.crane.transaction.MessageSender;
import com.crane.transaction.SmsMessageSender;
import com.crane.utils.DataUsageStatUpdater;
...
//    }
	...
	private void updateDraftSmsMessage(final Conversation conv, String contents) {
        ...
        mContentResolver.insert(Sms.CONTENT_URI, values);
