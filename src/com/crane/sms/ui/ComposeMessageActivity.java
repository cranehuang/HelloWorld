...
import com.crane.convs.ConversationList;
import com.crane.data.Contact;
import com.crane.data.ContactList;
import com.crane.data.Conversation;
import com.crane.data.WorkingMessage;
import com.crane.data.Conversation.ConversationQueryHandler;
import com.crane.data.WorkingMessage.MessageStatusListener;
...
import com.crane.sms.ui.MessageListAdapter;
import com.crane.sms.ui.MessageListView.OnSizeChangedListener;
import com.crane.sms.ui.RecipientsEditor.RecipientContextMenuInfo;
import com.crane.sms.widget.MmsWidgetProvider;
import com.crane.smsapp.LogTag;
import com.crane.smsapp.MmsConfig;
import com.crane.transaction.MessagingNotification;
import com.crane.utils.DraftCache;
import com.crane.utils.TelephonyIntents;
import com.crane.utils.TelephonyProperties;
...
//            mWorkingMessage.setHasEmail(mRecipientsEditor.containsEmail(), true);
    ...
    private boolean canAddToContacts(Contact contact) {
        ...
        if (!(MessageUtils.isEmailAddress(name) ||
                MessageUtils.isPhoneNumber(name)/* ||contact.isMe()*/)) {
            return false;
        }
        return true;
    }
...
//        PhoneNumberFormatter.setPhoneNumberFormattingTextWatcher(this, mRecipientsEditor);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        mIsSmsEnabled = /*MmsConfig.isSmsEnabled(this)*/true;
                ...
                case MESSAGE_LIST_QUERY_TOKEN:
                    ...
                    if (newSelectionPos != -1) {
                        ...
                        if (cursor != null && count > 0) {
                            cursor.moveToLast();
                            lastMsgId = cursor.getLong(MessageListAdapter.COLUMN_ID);
                        }
