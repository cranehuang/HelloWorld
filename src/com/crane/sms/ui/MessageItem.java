...
import com.crane.sms.ui.MessageListAdapter.ColumnsMap;
...
public class MessageItem {
    ...
    private SimpleDateFormat dataFormat = new SimpleDateFormat("MM-dd HH:mm");
...
//            System.out.println("----------->boxid = " + mBoxId);s
            mAddress = cursor.getString(columnsMap.mColumnSmsAddress);
            if (MessageUtils.isOutgoingFolder(mBoxId)) {
